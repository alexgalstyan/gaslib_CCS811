#include "gaslib_CCS811.h"

/**************************************************************************/
/*! 
    @brief  Setups the I2C interface and hardware and checks for communication. adafruit lib default begin 
    @param  addr Optional I2C address the sensor can be found on. Default is 0x5A
    @returns True if device is set up, false on any failure
*/
/**************************************************************************/
bool gaslib_CCS811::begin(uint8_t _mode, uint8_t addr)
{
	_i2caddr = addr;
	...
	setDriveMode(_mode);//CCS811_DRIVE_MODE_1SEC
...
*/
void gaslib_CCS811::setDriveMode(uint8_t mode)
{
...
*/
/**************************************************************************/
void gaslib_CCS811::enableInterrupt()
{
...
*/
/**************************************************************************/
void gaslib_CCS811::disableInterrupt()
{
...
*/
/**************************************************************************/
uint8_t gaslib_CCS811::readData()
{
	if(!available())
		return false;
	else{
...
void gaslib_CCS811::readBaseLine()
{
	uint8_t buf[2];
...
void gaslib_CCS811::writeBaseLine(uint16_t c_baseline)
{
	uint8_t buf[] = {(uint8_t)((c_baseline >> 8) & 0xFF), (uint8_t)(c_baseline & 0xFF)};
...
*/
/**************************************************************************/
void gaslib_CCS811::setEnvironmentalData(uint8_t humidity, double temperature)
{
...
*/
/**************************************************************************/
double gaslib_CCS811::calculateTemperature()
{
	uint8_t buf[4];
...
*/
/**************************************************************************/
void gaslib_CCS811::setThresholds(uint16_t low_med, uint16_t med_high, uint8_t hysteresis)
{
...
*/
/**************************************************************************/
void gaslib_CCS811::write8(byte reg, byte value)
{
...
*/
/**************************************************************************/
uint8_t gaslib_CCS811::read8(byte reg)
{
	uint8_t ret;
	this->read(reg, &ret, 1);
...
void gaslib_CCS811::read(uint8_t reg, uint8_t *buf, uint8_t num)
{
	uint8_t value;
	uint8_t pos = 0;
...
void gaslib_CCS811::write(uint8_t reg, uint8_t *buf, uint8_t num)
{
	Wire.beginTransmission((uint8_t)_i2caddr);
