//based (redistribute) on Adafruit library https://github.com/adafruit/gaslib_CCS811
#ifndef GASLIB_CCS811_H 
#define GASLIB_CCS811_H
...
struct eBaseLine {
	...
	uint32_t _hcounter; // Hour counter this incrementing every hour from start working
	uint16_t _baseline; // baseline value of CCS811
	uint8_t _err_id; //error id
};
/*=========================================================================*/
...
class gaslib_CCS811 {
	public:
		...
		bool begin(uint8_t _mode, uint8_t addr = CCS811_ADDRESS); 
        ...
        */
        ...
        /**************************************************************************/
        /*! 
            @brief  returns the stored measurement baseline. This does not read the balue. To do so, call readBaseLine()
            @returns eCO2 measurement as 16 bit integer
        */
        /**************************************************************************/
		uint16_t geteBaseLine() { return _baseline; }
        /**************************************************************************/
        /*! 
        ...
        */
		...
		uint8_t readData();
		void readBaseLine();
		void writeBaseLine(uint16_t c_baseline);
    ...
    -----------------------------------------------------------------------*/
        ...
        meas_mode _meas_mode; //measurement and conditions register
        ...
        error_id _error_id; //erros register
